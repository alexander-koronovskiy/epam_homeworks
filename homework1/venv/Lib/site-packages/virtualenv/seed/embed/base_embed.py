...
class BaseEmbed(Seeder):
    ...
    def add_parser_arguments(cls, parser, interpreter, app_data):
        ...
        group.add_argument(
            ...
            dest="download",
            action="store_false",
            help="pass to disable download of the latest {} from PyPI".format(
                "/".join(cls.distributions())
            ),
            default=True,
        )
        group.add_argument(
            ...
            dest="download",
            action="store_true",
            help="pass to enable download of the latest {} from PyPI".format(
                "/".join(cls.distributions())
            ),
            default=False,
        )
        ...
        for distribution, default in cls.distributions().items():
            parser.add_argument(
                ...
                dest=distribution,
                metavar="version",
                help="version of {} to install as seed: embed, bundle or exact version".format(
                    distribution
                ),
                default=default,
            )
